# Niom's Restaurant - Food Order Chatbot Backend
    ...
    if session_id not in inprogress_orders:
        ...
        if order_id == -1:
            ...
            fulfillment_text = f"Awesome! We have placed your order. " \
                               ...
                               f"Your total is {order_total} BDT, payable at the time of delivery. " \
                               f"Thank you for ordering from Niom's Restaurant!"
